...
const Sidebar = () => {
	return (
		<div className="bg-gray-100 text-gray-900 h-screen fixed w-16 md:w-64 border-r border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white">
			<h1 className='text-2xl font-bold hidden md:block mt-4 border-b p-4 flex justify-between items-center text-center dark:border-gray-600 dark:bg-gray-900 dark:text-white'>URBN LUXE</h1>
